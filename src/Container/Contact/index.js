...
const  ContactContainer = ()=>{
    const myData = [
        ...
        {name:'Linkedin', link:'https://www.linkedin.com/in/adarsh-raj-20a30b203/', text:'Follow to my linkedin.'},
        ...
        {name:'GitHub', link:'https://github.com/adarsh291201', text:'Follow to my github account.'},
        // {name:'YouTube', link:'https://www.youtube.com/c/AzadMalikRohit', text:'Follow to my youtube channel.'},
        {name:'Email', link:'rajadarsh2912@gmail.com',  text:'write to me a mail'}
    ]
    return (
            ...
            <Row>
                <Col className='conectIcon'>
                    <ul className='socialIconsList'>
                        ...
                        <li>
                            <a rel="noreferrer" href="https://www.linkedin.com/in/adarsh-raj-20a30b203/n" target="_blank">
                                <BsLinkedin />
                            </a>
                        </li>
                        {/* <li>
                        ...
                        {/* <li>
                            <a rel="noreferrer" href=".com/" target="_blank">
                                <Bsemail />
                            </a>
                        </li> */}
                        <li>
